...
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_ALQ.XPT", clear
sort seqn
save "P_ALCOHOL.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_DR1TOT.XPT", clear
sort seqn
save "P_DIETRECALL1.DTA", replace 
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_DR2TOT.XPT", clear
sort seqn
save "P_DIETRECALL2.DTA", replace 
...
drop  _merge
merge 1:1 seqn using "P_ALCOHOL.DTA"
drop  _merge
merge 1:1 seqn using "P_DIETRECALL1.DTA"
drop  _merge
merge 1:1 seqn using "P_DIETRECALL2.DTA"
drop  _merge
...
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/ALQ_I.XPT", clear
sort seqn
save "ALCOHOL_I.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DR1TOT_I.XPT", clear
sort seqn
save "DIETRECALL1_I.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2015-2016/DR2TOT_I.XPT", clear
sort seqn
save "DIETRECALL2_I.DTA",replace
...
drop  _merge
merge 1:1 seqn using "ALCOHOL_I.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL1_I.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL2_I.DTA"
drop  _merge
...
sort seqn
save "ALCOHOL_H.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DR1TOT_H.XPT", clear
sort seqn
save "DIETRECALL1_H.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2013-2014/DR2TOT_H.XPT", clear
sort seqn
save "DIETRECALL2_H.DTA",replace
...
drop  _merge
merge 1:1 seqn using "ALCOHOL_H.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL1_H.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL2_H.DTA"
drop  _merge
...
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/ALQ_G.XPT", clear
sort seqn
save "ALCOHOL_G.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/DR1TOT_G.XPT", clear
sort seqn
save "DIETRECALL1_G.DTA",replace
import sasxport5 "https://wwwn.cdc.gov/Nchs/Nhanes/2011-2012/DR2TOT_G.XPT", clear
sort seqn
save "DIETRECALL2_G.DTA",replace
...
drop  _merge
merge 1:1 seqn using "ALCOHOL_G.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL1_G.DTA"
drop  _merge
merge 1:1 seqn using "DIETRECALL2_G.DTA"
drop  _merge
...
use "/Users/taynara/Desktop/Prediabetes Paper/nhanes20172020.dta"


*append datasets together
append using "/Users/taynara/Desktop/Prediabetes Paper/nhanes2015.dta" "/Users/taynara/Desktop/Prediabetes Paper/nhanes2013.dta" "/Users/taynara/Desktop/Prediabetes Paper/nhanes2011.dta"


*saving as one merged dataset*
save predm101823.dta, replace

use predm101823.dta, clear
rename *, lower
set more off
...
save "/Users/taynara/Desktop/Prediabetes Paper/predm101823.dta", replace 

******************************* EVERY TIME YOU NEED TO USE THE DATASET YOU CAN START HERE *******************************
 
use "/Users/taynara/Desktop/Prediabetes Paper/predm101823.dta"
...
*waist circumference Black Hispanic White
gen wc =.
replace wc = 0 if (bmxwaist <= 88  & riagendr ==2) | (bmxwaist <= 102  & riagendr ==1)
replace wc = 1 if (bmxwaist > 88 & bmxwaist !=.  & riagendr ==2) | (bmxwaist > 102 & bmxwaist !=. & riagendr ==1)

*waist circumference Asin
gen wcasian =.
replace wcasian = 0 if (bmxwaist <= 79  & riagendr ==2) | (bmxwaist <= 89  & riagendr ==1)
replace wcasian = 1 if (bmxwaist >79 & bmxwaist !=.  & riagendr ==2) | (bmxwaist > 89 & bmxwaist !=. & riagendr ==1)


*** ALCOHOL USE
*never, former, current 

*combine variable ALQ110 from 2011,2013,2015 and ALQ111 from 201-2020: ever had a drink of any kind of alcohol. 1 = yes 2 = no(never) 
gen ever_alcohol =. 
replace ever_alcohol = 1 if alq110== 1 |  alq111== 1
replace ever_alcohol = 2 if alq110== 2 |  alq111== 2

*2013-2015 any alcohol in the past 12 months? 0 = no, 1 equals yes   
gen no12alcohol =.
replace no12alcohol = 0 if alq120q <=0 & alq120q !=. 
replace no12alcohol = 1 if alq120q >=1 & alq120q !=. & alq120q !=777 & alq120q !=999

*201 any alcohol in the past 12 months? 0 = no, 1 equals yes   
gen alcohol2017 =.
replace alcohol2017 = 0 if  alq121 == 0
replace alcohol2017 = 1 if alq121 == 1 |alq121 == 2 | alq121 == 3 | alq121 == 4 | alq121 == 5 | alq121 == 6 | alq121 == 7 | alq121 == 8 | alq121 == 9 | alq121 == 10 

*combine 2013-2015 any alcohol in the past 12 months with 2017 past 12 mo how often (alq121)
gen alcohol12 =. 
replace alcohol12 =0 if no12alcohol == 0 | alcohol2017 == 0
replace alcohol12 =1 if no12alcohol == 1 | alcohol2017 == 1

*create alcohol variable for never, former and current drinker 
generate alcstatus =.
replace alcstatus = 1 if ever_alcohol == 2 
replace alcstatus = 2 if ever_alcohol ==1  & alcohol12 == 0
replace alcstatus = 3 if ever_alcohol ==1  & alcohol12 == 1

*label variable alcohol status 
label define alcstatus 1 "never" 2 "former" 3 "current" 
label values alcstatus alcstatus


**frequency per week of alcohol use 
*** 2011-2015: create a variable that combines the continuous variable how often drink alcohol over past 12 month with the variables # daus drink alcohol per week/month or year
gen alq_days_per_week = .
replace alq_days_per_week = alq120q if alq120u == 1 
replace alq_days_per_week = alq120q / 4 if alq120u == 2  
replace alq_days_per_week = alq120q / 52 if alq120u == 3  

*create a three-level variable  in which 1 = 0 days; 2= <=2 days; 3=>=2 days / week having a drink. 0 also includes those who said "no" to the questions AlQ110 "had at least 12 alcohol drink in lifetime and 1 "yes" 
gen alq_alcohol_level = .
replace alq_alcohol_level = 1 if alq_days_per_week == 0 | alq101==2
replace alq_alcohol_level = 2 if alq_days_per_week <= 2 & alq101==1
replace alq_alcohol_level = 3 if (alq_days_per_week > 2 & alq_days_per_week!=.) & alq101==1



*in 2017, NHANES replaced the continuous variable to a categorical variable. Using the categoies I created a three-level variable  in which 1 = 0 days; 2= <=2 days; 3=>=2 days / week having a drink
*check codebook https://wwwn.cdc.gov/Nchs/Nhanes/2017-2018/P_ALQ.htm#ALQ121 to understand each code from 0-10. 
gen alcoholweek =.
replace alcoholweek =1 if alq121 ==0  |  alq111==2 
replace alcoholweek =2 if alq121 ==4 | alq121 ==5 | alq121 ==6 | alq121 ==7 | alq121 ==8 | alq121 ==9 | alq121 ==10  & alq111==1
replace alcoholweek =3 if alq121 ==1 | alq121 ==2 | alq121 ==3 & alq111==1

******creating a variable combining the alcohol/week variables from 2011-2015 and 2017: alq_days_per_week and alcoholweek
gen combalcoholweek =. 
replace combalcoholweek =1 if alq_alcohol_level == 1 | alcoholweek ==1
replace combalcoholweek =2 if alq_alcohol_level == 2 | alcoholweek ==2
replace combalcoholweek =3 if alq_alcohol_level == 3 | alcoholweek ==3


** diet variable: 
*total mean energy is the mean of total energy on day 1 dr1kcal and total energy on day 2 dr2kcal
egen mean_energy = rowmean(dr1tkcal dr2tkcal)
 
 *categorical 
gen energy_category =.
replace energy_category = 1 if riagendr == 2 & mean_energy <= 2000
replace energy_category = 2 if riagendr == 2 & mean_energy > 2000 & mean_energy !=.
replace energy_category = 3 if riagendr == 1 & mean_energy <= 2500
replace energy_category = 4 if riagendr == 1 & mean_energy > 2500 & mean_energy !=.
 
*label 
label define energy_category 1 "<=2000 women" 2 ">2000 women" 3 "<=2500 men" 4 ">2500 men" 
label values energy_category energy_category 


*one catgorical varaible just for women and just for men 
gen womenenergy_category =.
replace womenenergy_category = 0 if riagendr == 2 & mean_energy <= 2000
replace womenenergy_category = 1 if riagendr == 2 & mean_energy > 2000 & mean_energy !=.

gen menenergy_category =.
replace menenergy_category = 0 if riagendr == 1 & mean_energy <= 2500
replace menenergy_category = 1 if riagendr == 1 & mean_energy > 2500 & mean_energy !=.

**binary variable for the recommended energy intake: 2000 for women and 2500 for men
gen bienergy_category =.
replace bienergy_category =0 if (riagendr == 2 & mean_energy <= 2000) | (riagendr == 1 & mean_energy <= 2500)
replace bienergy_category =1 if (riagendr == 2 & mean_energy > 2000 & mean_energy !=.) | (riagendr == 1 & mean_energy > 2500 & mean_energy !=.)
...
tab combalcoholweek race if inclusion1==1

tab bienergy_category race if inclusion1==1
...
*only for asians wc
tab wcasian race if inclusion1==1
...
svy: regress ridageyr i.race if inclusion1==1
...
svy: tab combalcoholweek race if inclusion==1, col
svy: proportion combalcoholweek if inclusion==1, over(race)

svy: tab bienergy_category race if inclusion==1, col
svy: proportion bienergy_category if inclusion==1, over(race)
...
svy: tab wcasian race if inclusion==1, col
svy: proportion wcasian if inclusion==1, over(race)
...
tab combalcoholweek edu4 if inclusion1==1
tab bienergy_category edu4 if inclusion1==1
...
svy: mean ridageyr if inclusion1==1
svy: mean ridageyr if inclusion==1, over(edu4)
svy: regress ridageyr i.edu4 if inclusion==1
...
svy: tab combalcoholweek edu4 if inclusion==1, col
svy: proportion combalcoholweek if inclusion==1, over(edu4)

svy: tab bienergy_category edu4 if inclusion==1, col
svy: proportion bienergy_category if inclusion==1, over(edu4)
...
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa i.combalcoholweek i.bienergy_category i.edu4 if inclusion==1 

*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.edu4 if inclusion==1 
...
*adjusted socio-demographic + health-related 
svy: logistic predmada ib4.edu4 ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category i.race if inclusion ==1

*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.edu4  ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.race if inclusion==1 
...
*adjusted socio-demographic + health-related 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc  i.smoke i.anypa  i.combalcoholweek i.bienergy_category i.edu4 if inclusion ==1

*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc  i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.edu4 if inclusion ==1
...
*adjusted socio-demographic + health-related 
svy:logistic predmaware ib4.edu4 ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category i.race if inclusion ==1 

*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.edu4  ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.race if inclusion ==1 
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa   i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==1 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc  i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==2 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==3 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmada ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==4 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==1 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc  i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==2 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==3 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
svy: logistic predmaware ib4.race ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist if edu4==4 & inclusion==1
...
*adjusted socio-demographic + health-related + clinical 
*prediabetes
svy: logistic predmada ib4.race#ib4.edu4  ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.race if inclusion ==1 

*awareness
svy: logistic predmaware ib4.race#ib4.edu4  ridageyr i.riagendr indfmpir i.insurance i.placehc i.smoke i.anypa  i.combalcoholweek i.bienergy_category bmxbmi bmxwaist i.race if inclusion ==1 
